...
<body>
  ...
  <div class="field3">
    <form action="include/certificateAddBack.php" class="main3 border border-2" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="serialNum">
...
?>
      ...
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Back Serial Number</label>
        <input type="text" class="form-control" id="exampleInputPassword1" name="BSerialNum">
      </div>

      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Effective Date</label>
        <input type="date" class="form-control" id="exampleInputPassword1" name="Edate">
      </div>

      <button type="submit" class="btn btn-primary" name="addCertificate">Add Certificate</button>
